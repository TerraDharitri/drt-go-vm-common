...
func TestOperationDataFieldParser_ParseRelayed(t *testing.T) {
	...
	t.Run("RelayedTxV2WithNFTTransfer", func(t *testing.T) {
		...
		nftTransferData := []byte("DCDTNFTTransfer@4c4b46524d2d396431656138@34ae14@728faa2c8883760aaf53bb@000000000000000005001e2a1428dd1e3a5146b3960d9e0f4a50369904ee5483@636c61696d5265776172647350726f7879@00000000000000000500a655b2b534218d6d8cfa1f219960be2f462e92565483")
		dataField := []byte(core.RelayedTransactionV2 +
			"@" +
		...
		require.Equal(t, &ResponseParseData{
			...
			Tokens:           []string{"LKFRM-9d1ea8-34ae14"},
			Receivers:        [][]byte{rcv},
			ReceiversShardID: []uint32{1},
